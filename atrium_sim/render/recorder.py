...
def record_episode(env, policy, path: str, seed: int | None = None, spec=None, plan=None) -> dict:
    ...
    try:
        options = {"plan": plan} if plan is not None else ({"spec": spec} if spec is not None else None)
